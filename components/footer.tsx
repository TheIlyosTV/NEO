      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              {t["footer.about"] || "Premium clothing and footwear for the modern individual."}
            </p>
          ...
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wider mb-4">{t["footer.shop"] || "Shop"}</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/category/perfumery" className="text-gray-600 hover:text-gray-900">
                  {t["footer.perfumery"] || "Perfumery"}
                </Link>
              </li>
              <li>
                <Link href="/new-arrivals" className="text-gray-600 hover:text-gray-900">
                  {t["footer.newArrivals"] || "New Arrivals"}
                </Link>
              </li>
            </ul>
          </div>
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wider mb-4">{t["footer.help"] || "Help"}</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/store-locator" className="text-gray-600 hover:text-gray-900">
                  {t["footer.storeLocator"] || "Store Locator"}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              {t["footer.subscribeText"] || "Subscribe to receive updates, access to exclusive deals, and more."}
            </p>
            <div className="flex flex-col sm:flex-row gap-2">
              <Input type="email" placeholder={t.emailPlaceholder || "Enter your email"} className="flex-grow" />
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} LUXMODE. {t["footer.rights"] || "All rights reserved."}
          </p>
